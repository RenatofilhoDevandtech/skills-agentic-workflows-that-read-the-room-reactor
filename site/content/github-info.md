...
- **Agentic Workflows are here:** GitHub now supports agentic workflows that can read repository context, fetch external web sources, and automatically draft pull requests for human review.
